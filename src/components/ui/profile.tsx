        ...
        <div className="bg-charcoal flex rounded-xl flex-col">
            ...
            <div className="m-9 flex flex-col">
                <div className="flex justify-between">
                    <h2 className="text-2xl sm:text-4xl font-bold tracking-normal text-biege">Welcome Admin</h2>
                    <span
                ...
                <div className="flex flex-col mt-2 text-sm sm:text-base">
                    <span className="text-grayDark leading-5">Manget at Karmalife - Industry</span>
                    ...
                    <div className="flex flex-wrap max-md mt-6 gap-2">
                        {["share", "help", "gift"].map((item) => {
                            return <span className="text-xs px-5 py-1 bg-grayDark rounded-lg capitalize">{item}</span>;
                        })}
                    </div>
                </div>
            </div>
