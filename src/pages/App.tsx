...
const App = () => {
    ...
    const { isDataSave, isLoading } = useSelector((state: { data: InitialStateProps }) => state.data);
                ...
                <div className="flex flex-col items-center justify-center w-screen h-screen px-10 sm:px-0">
                    <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
                        <div className="flex flex-col space-y-2 text-center">
                            ...
                            <p className="text-sm text-grayDark">Enter your account information for KYC</p>
                        </div>
                        <AccountForm />
                        <button
                            type="button"
                        ...
                        <p className="px-8 text-sm text-center text-lightGreen">
                            <Link className="underline hover:text-brand underline-offset-4" to="/admin-login">
